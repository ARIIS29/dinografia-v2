...
class Ejercicios_letra_b extends CI_Controller
{
	...
	{
		$this->load->view('layout/header_ejercicios/header_letrab/header_menuBosqueBambu');
		$this->load->view('ejercicios/ejercicios_letra_b/index');
	...
	{
		$this->load->view('layout/header_descubriendo_mensajes_secretos_b');
		$this->load->view('ejercicios/ejercicios_letra_b/descubriendo_mensajes_secretos_b');
		$this->load->view('layout/footer');
	}

	public function enviarEvaluacionMensajesSecretosb()
	{
		$fecha_registro = date("Y-m-d H:i:s");
		$key_1 = "progreso-" . date("Y-m-d-H-i-s", strtotime($fecha_registro));
		$identificador_1 = hash("crc32b", $key_1);
	...
	{
		$this->load->view('layout/header_ejercicios/header_letrab/header_explorador_hojas_b');
		$this->load->view('ejercicios/ejercicios_letra_b/explorador_hojas_b');
		$this->load->view('layout/footer');
	}
	...
	{
		$this->load->view('layout/header_ejercicios/header_letrab/header_encontrando_objetos_b');
		$this->load->view('ejercicios/ejercicios_letra_b/encontrando_objetos_b');
		$this->load->view('layout/footer');
	}

	public function enviarEvaluacionEncontrandoObjetosB()
	{
		$fecha_registro = date("Y-m-d H:i:s");
		$key_1 = "progreso-" . date("Y-m-d-H-i-s", strtotime($fecha_registro));
		$identificador_1 = hash("crc32b", $key_1);
		...
		if ($estrellas <= 100) {
			...
			$evaluacion = '¡Casi lo logras!';
			$observacion = "<b>Elementos perdidos - letra b👀</b><br>¡Casi lo logras explorador!🌟<br><i>Sugerencia: Estás cerca. Revisa más detenidamente los elementos y asegúrate de comparar todos los detalles.</i><br>Elementos encontrados: $objetosCorrectos de 77 elementos perdidos <br> Errores cometidos: $objetosIncorrectos<br>";
	...
	{
		$this->load->view('layout/header_ejercicios/header_letrab/header_dino_dice');
		$this->load->view('ejercicios/ejercicios_letra_b/dino_dice');
		$this->load->view('layout/footer');
	}
	...
	public function que_animal_recuerdas()
	{
		$this->load->view('layout/header_ejercicios/header_letrab/header_que_animal_recuerdas');
		$this->load->view('ejercicios/ejercicios_letra_b/que_animal_recuerdas');
		$this->load->view('layout/footer');
	}
}

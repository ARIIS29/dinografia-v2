...
<section class="mt-8">
    <div class="container">
        <div class="row d-flex justify-content-evenly">
            ...
            <?php foreach ($galeriasg_lista as $key => $galeria) : ?>
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div id="card1" class="card me-5">
                        <div id="cara1" class="cara cara1 d-block">
                            <div class="content bg-<?php echo $galeria->evaluacion; ?>">
                                <img src="<?php echo '../'.$galeria->url_imagen ?>" width="100%" class="img-fluid">
                                <h6 class="card-title ms-1">Trazo <?php echo $key + 1 ?></h6>
                                <h6 class="card-text ms-1 mt-3">Fecha: <?php echo $galeria->fecha_registro ?></h6>
                            </div>
                        </div>

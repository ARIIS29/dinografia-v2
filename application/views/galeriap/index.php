...
<section class="mt-8">
    <div class="container">
        <div class="row d-flex justify-content-evenly">
            <p class="indicaciones mt-5">En esta sección se muestran los trazos que realizaste de la letra p.¡Evalúa tu desempeño en los trazos como explorador!.</p>
            <?php foreach ($galeriasp_lista as $key => $galeria) : ?>

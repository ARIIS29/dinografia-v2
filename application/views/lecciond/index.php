...
<section class="mt-8">
    <div class="container">
        ...
        <div class="col-lg-6 col-md-6 d-none d-sm-block">
            ...
            <img src="<?php echo base_url('almacenamiento/img/letra-d/msjd1.png') ?>" alt="" class="img-fluid" width="70%">
        </div>
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-12">
                ...
                <video controls>
                    <source src="<?php echo base_url('almacenamiento/img/letra-d/letrad-escritura.mp4'); ?>" type="video/mp4">
                </video>
            </div>
            <!-- Columna para la imagen de fondo y el canvas -->
            <div class="col-lg-6 col-md-6 col-12" style="position: relative;">
                <!-- Imagen de fondo -->
                <img id="fondo-letrab" src="<?php echo base_url('almacenamiento/img/letra-d/letra-d.gif'); ?>" alt="Background Image" style="display: block;" class="img-fluid">
                <!-- Canvas para dibujar -->
                <canvas id="canvas" style="border:1px solid #000000;"></canvas>
                <br>
                <!-- Selector de color -->
                <input type="color" id="color" value="#E87032" title="Gama de colores">
                <!-- Selector de grosor -->
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        botonGuardar.addEventListener('click', () => {
            ...
            imagenFondo.onload = () => {
                ...
                fetch(baseUrl + 'lecciond/guardarImagen', {
                        method: 'POST',
        ...
        function mostrarMensajeExito() {
            ...
            mensaje.textContent = '¡Captura guardada con éxito en la galería D!';

...
<head>
    ...
    <title>Galeria trazo en la arena</title>
    <!-- <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous"> -->
    <link rel="stylesheet" href="<?php echo base_url('assets/bootstrap-css/bootstrap.css') ?>">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css">
    <link rel="stylesheet" href="<?php echo base_url('assets/css/mystyle_galeriat.css') ?>">
        ...
        <nav class="navbar navbar-color navbar-expand-lg navbar-light fixed-top">
            <div class="container-fluid">
                <div class="col-lg-4 col-md-4">
                    <a class="nav-link" href="<?php echo base_url('MenuPrincipal') ?>"><img src="<?php echo base_url('almacenamiento/img/dinografia-log2.svg') ?>" alt="" class="img-fluid"></a>
                </div>
                <div class="col-lg-4 col-md-4 text-center d-none d-sm-block">
                ...
                <div class="col-lg-4 col-md-4 row d-flex justify-content-end">
                    ...
                    <div class="col-lg-4 col-md-4 d-none d-sm-block btn-ejercicios">
                        <a class="nav-link" href="<?php echo base_url('MenuEjercicios') ?>">
                            <img src="<?php echo base_url('almacenamiento/img/ejercicios.svg') ?>" alt="" class="img-fluid enlargable">
                        </a>
                    </div>
                </div>

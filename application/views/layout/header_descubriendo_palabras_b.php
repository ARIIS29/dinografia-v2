...
<head>
    ...
    <title>Descubriendo palabras - letra  b</title>
    ...
    <section id="header-juego" class="d-none">
        <nav class="navbar navbar-color navbar-expand-lg navbar-light fixed-top">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-3 col-md-3">
                        <a class="nav-link" href="<?php echo base_url('ejercicios/ejercicios_letra_b/descubriendo_palabras_b') ?>"><img src="<?php echo base_url('almacenamiento/img/btn-regresar.png') ?>" alt="" class="img-fluid" width="30%"></a>
                    </div>

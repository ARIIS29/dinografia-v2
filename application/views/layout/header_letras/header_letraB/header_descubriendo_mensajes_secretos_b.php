...
<head>
    ...
    <title>Descubriendo mensajes</title>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/css/estilos_juegos/mystyle_descubriendo_mensajes_secretos.css') ?>">
        ...
        <nav class="navbar navbar-color navbar-expand-lg navbar-light fixed-top">
            <div class="container-fluid">
                ...
                <div class="col-lg-6 col-md-6 justify-aling-center text-center d-none d-md-block">
                    <h1 class="titulo-h1-bambu">MENSAJES SECRETOS</h1>
                </div>
                <div class="col-lg-6 col-md-6 justify-aling-center text-center d-block d-md-none">
                    <h1 class="titulo-h1-bambu-movil">MENSAJES SECRETOS</h1>
                </div>
                <div class="col-lg-3 col-md-3 justify-aling-center tipografia">
        ...
        <nav class="navbar navbar-color navbar-expand-lg navbar-light fixed-top d-none d-md-block">
            <div class="container-fluid">
                <div class="col-lg-2 col-md-2 justify-aling-center tipografia">
                    <a href="<?php echo site_url('letras/bosque_bambu/descubriendo_mensajes_secretos_b') ?>" class="btn boton-regresar-bambu float-start"> <i class="fas fa-arrow-left"></i></a>
                </div>
                <div class="col-lg-6 col-md-6 justify-aling-center text-center texto_indicaciones_bambu">
                    <img id="dinoIndicaciones" src="<?php echo base_url('almacenamiento/img/bosque_bambu/dino-indicaciones.png') ?>" alt="Img-Dino-Indicaciones" class="img-fluid me-3" style="cursor: pointer;" width="8%">¡Vamos a descubrir el mensaje secreto! 🔍 <br>Haz clic en el botón verde ✅ para verificar tu respuesta.
                </div>

...
<head>
    ...
    <title>¡Hazle caso al Dino - d!</title>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/css/estilos_juegos/mystyle_dino_dice_d.css') ?>">
...
<body class="body-explorando-letrab">
        ...
        <nav class="navbar navbar-color navbar-expand-lg navbar-light fixed-top">
            <div class="container-fluid">
                <div class="col-lg-3 col-md-3 justify-aling-center tipografia">
                    <a href="<?php echo site_url('letras/desierto/explora_y_descubre_d') ?>" class="btn boton-regresar-desierto float-start"> <i class="fas fa-arrow-left"></i></a>
                </div>
                <div class="col-lg-6 col-md-6 justify-aling-center text-center d-none d-md-block">
                    <h1 class="titulo-h1-desierto">¡HAZLE CASO AL DINO!</h1>
                </div>
                <div class="col-lg-6 col-md-6 justify-aling-center text-center d-block d-md-none">
                    <h1 class="titulo-h1-desierto-movil">¡HAZLE CASO AL DINO</h1>
                </div>
                <div class="col-lg-3 col-md-3 justify-aling-center tipografia">
    ...
    <section id="header-juego" class="d-none">
        <nav class="navbar navbar-color-d navbar-expand-lg navbar-light fixed-top">
            <div class="container-fluid">
                <div class="col-lg-3 col-md-3 justify-aling-center tipografia">
                    <a href="<?php echo site_url('letras/desierto/dino_dice_d') ?>" class="btn boton-regresar-desierto float-start" id="btnRegresar"> <i class="fas fa-arrow-left"></i></a>
                </div>
                <div class="col-lg-6 col-md-6 justify-aling-center text-center texto_indicaciones_desierto" id="instruccion">
                    <img id="dinoIndicaciones" src="<?php echo base_url('almacenamiento/img/desierto/dino-indicaciones.png') ?>" alt="Img-Dino-Indicaciones" class="img-fluid me-3" style="cursor: pointer;" width="8%">
                </div>

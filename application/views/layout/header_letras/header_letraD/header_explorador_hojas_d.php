...
<head>
    ...
    <title>Explorador de hojas - d</title>
        ...
        <nav class="navbar navbar-color navbar-expand-lg navbar-light fixed-top">
            ...
            <div class="col-lg-3 col-md-3 justify-aling-center tipografia">
                ...
                <div class="col-lg-6 col-md-6 justify-aling-center text-center d-none d-md-block">
                    <h1 class="titulo-h1-desierto">EXPLORADOR DE HOJAS</h1>
                </div>
                <div class="col-lg-6 col-md-6 justify-aling-center text-center d-block d-md-none">
                    <h1 class="titulo-h1-desierto-movil">EXPLORADOR DE HOJAS</h1>
                </div>
                <div class="col-lg-3 col-md-3 justify-aling-center tipografia">
        ...
        <nav class="navbar navbar-color-d navbar-expand-lg navbar-light fixed-top d-none d-md-block">
            <div class="container-fluid">
                <div class="col-lg-2 col-md-2 justify-aling-center tipografia">
                    <a href="<?php echo site_url('letras/desierto/explorador_hojas_d') ?>" class="btn boton-regresar-desierto float-start" id="btnRegresar"> <i class="fas fa-arrow-left"></i></a>
                </div>
                <div class="col-lg-6 col-md-6 justify-aling-center text-center texto_indicaciones_desierto">
                    <img id="dinoIndicaciones" src="<?php echo base_url('almacenamiento/img/desierto/dino-indicaciones.png') ?>" alt="Img-Dino-Indicaciones" class="img-fluid me-3" style="cursor: pointer;" width="8%">¡Vamos explorador! ¡Haz clic o presiona en cada hoja que aparezca y atrápala antes de que se escape! 
                </div>
                <div class="col-lg-3 col-md-3 d-flex justify-items-center texto_indicaciones_desierto">
                    ...
                    <div class="col-lg-4 col-md-4 d-flex align-items-center">
                        <img src="<?php echo base_url('almacenamiento/img/desierto/hojad.png') ?>" alt="" class="img-fluid ms-4" width="40%">
                        <span id="contadorPuntos">0</span>
                    </div>
                    <div class="col-lg-4 col-md-4 d-flex align-items-center">

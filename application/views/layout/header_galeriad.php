...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/css/mystyle_galeriad.css') ?>">
        ...
        <nav class="navbar navbar-color navbar-expand-lg navbar-light fixed-top">
            <div class="container-fluid">
                ...
                <div class="col-lg-5 col-md-5 text-center d-none d-sm-block">
                    <img src="<?php echo base_url('almacenamiento/img/letra-d/galeria_letrad.png') ?>" alt="" class="img-fluid" width="100%">
                </div>
                <div class="col-lg-4 col-md-4 row d-flex justify-content-end">
                    ...
                    <div class="col-lg-4 col-md-4 d-none d-sm-block btn-ejercicios">
                        <a class="nav-link" href="<?php echo base_url('Lecciond') ?>">
                            <img src="<?php echo base_url('almacenamiento/img/letra-d/btn-desierto.png') ?>" alt="" class="img-fluid enlargable">
                        </a>
                    </div>
                </div>

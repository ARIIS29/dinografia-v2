...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/css/mystyle_descubriendo_palabras.css') ?>">
            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-3 col-md-3 row">
                    <div class="col-lg-6 col-md-6 d-flex align-items-center">
                        ...
                        <span class="text-azul ms-2" id="timer">00:00</span>
                    </div>
                    <div class="col-lg-6 col-md-6 d-flex align-items-center">
                        <img src="<?php echo base_url('almacenamiento/img/movimientos.png') ?>" alt="" class="img-fluid me-2" width="40%">
                        <span class="text-azul ms-2" id="contadorVidas">3</span>
                    </div>
                </div>

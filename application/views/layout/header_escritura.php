...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/css/mystyle_escritura.css') ?>">
        ...
        <nav class="navbar navbar-color navbar-expand-lg navbar-light fixed-top">
            <div class="container-fluid">
                ...
                <div class="col-lg-5 col-md-5 text-center d-none d-sm-block">
                    <img src="<?php echo base_url('almacenamiento/img/titulos/bitacora_explorador.png') ?>" alt="" class="img-fluid" width="100%">
                </div>

...
<head>
    ...
    <title>Exploremos las letras</title>
    <!-- <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous"> -->
    <link rel="stylesheet" href="<?php echo base_url('assets/bootstrap-css/bootstrap.css') ?>">
    <link rel="stylesheet" href="<?php echo base_url('assets/css/mystyle_exploremos.css') ?>">
        ...
        <nav class="navbar navbar-color navbar-expand-lg navbar-light fixed-top">
            <div class="container-fluid">
                ...
                <div class="col-lg-5 col-md-5 text-center d-none d-sm-block">
                    <img src="<?php echo base_url('almacenamiento/img/titulos/exploremos.png') ?>" alt="" class="img-fluid" width="80%">
                </div>

...
<head>
    ...
    <title>Explorando caminos</title>
    <!-- <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous"> -->
    <link rel="stylesheet" href="<?php echo base_url('assets/bootstrap-css/bootstrap.css') ?>">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css">
    <link rel="stylesheet" href="<?php echo base_url('assets/css/mystyle_laberinto.css') ?>">
            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-3 col-md-3 row">
                    <div class="col-lg-6 col-md-6 d-flex align-items-center">
                        ...
                        <span class="text-azul ms-2" id="tiempo">00:00</span>
                    </div>
                    <div class="col-lg-6 col-md-6 d-flex align-items-center">
                        <img src="<?php echo base_url('almacenamiento/img/movimientos.png') ?>" alt="" class="img-fluid me-2" width="40%">
                        <span class="text-azul ms-2" id="contadorMovimientos">0</span>
                    </div>
                </div>

...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/css/mystyle_grafismo.css') ?>">
        ...
        <nav class="navbar navbar-color navbar-expand-lg navbar-light fixed-top">
            <div class="container-fluid">
                ...
                <div class="col-lg-6 col-md-6 d-flex justify-items-center d-none d-sm-block">
                    <img src="<?php echo base_url('almacenamiento/img/titulos/ejercicios_grafismo.png') ?>" alt="" class="img-fluid" width="90%">
                </div>
                <div class="col-lg-3 col-md-3 row">
                    <div class="col-lg-6 col-md-6 d-flex align-items-center">
                        <a class="nav-link" href="<?php echo base_url('galeria/galeriag')?>"><img src="<?php echo base_url('almacenamiento/img/botones/galerias-btn.png') ?>" alt="" class="img-fluid"></a>
                    </div>
                </div>

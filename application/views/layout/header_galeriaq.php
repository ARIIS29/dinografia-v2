            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-4 col-md-4 row d-flex justify-content-end">
                    ...
                    <div class="col-lg-4 col-md-4 d-none d-sm-block btn-ejercicios">
                        <a class="nav-link" href="<?php echo base_url('Leccionq') ?>">
                            <img src="<?php echo base_url('almacenamiento/img/letra-q/trazoq.png') ?>" alt="" class="img-fluid enlargable">
                        </a>
                    </div>
                </div>

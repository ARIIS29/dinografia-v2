...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/css/mystyle_evaluacion_lecciones.css') ?>">
        ...
        <nav class="navbar navbar-color navbar-expand-lg navbar-light fixed-top">
            <div class="container-fluid">
                ...
                <div class="col-lg-9 col-md-9 justify-aling-center">
                    <a class="nav-link" href="<?php echo base_url('') ?>"><img src="<?php echo base_url('almacenamiento/img/titulos/evaluacion_rutas.png') ?>" alt="" class="img-fluid"></a>

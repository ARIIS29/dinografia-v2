...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/css/mystyle_aventurasTrazo.css') ?>">
        ...
        <nav class="navbar navbar-color navbar-expand-lg navbar-light fixed-top">
            <div class="container-fluid">
                ...
                <div class="col-lg-8 col-md-8">
                    <img src="<?php echo base_url('almacenamiento/img/titulos/aventuras_trazo.png') ?>" alt="" class="img-fluid" width="60%">
                </div>
            </div>
        </nav>
    </section>
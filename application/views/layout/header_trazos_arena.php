...
<head>
    ...
    <title>Trazos en la Arena</title>
    <!-- <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous"> -->
    <link rel="stylesheet" href="<?php echo base_url('assets/bootstrap-css/bootstrap.css') ?>">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css">
    <link rel="stylesheet" href="<?php echo base_url('assets/css/mystyle_trazos_arena.css') ?>">
    ...
    <section>
        <nav class="navbar navbar-color navbar-expand-lg navbar-light fixed-top">
            <div class="container-fluid">
                ...
                <div class="col-lg-6 col-md-9 d-flex justify-items-center d-none d-sm-block">
                    <img src="<?php echo base_url('almacenamiento/img/titulos/trazos_arena.png') ?>" alt="" class="img-fluid" width="70%">
                </div>
                <div class="col-lg-3 col-md-3 row">
                    <div class="col-lg-5 col-md-5 d-flex align-items-center">
                        <a class="nav-link" href="<?php echo base_url('galeria/galeriat')?>"><img src="<?php echo base_url('almacenamiento/img/botones/galerias-btn.png') ?>" alt="" class="img-fluid"></a>
                    </div>
                </div>

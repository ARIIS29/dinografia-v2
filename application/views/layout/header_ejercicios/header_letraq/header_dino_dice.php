...
<head>
    ...
    <title>Dino dice - letra d</title>
    <!-- <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous"> -->
    <link rel="stylesheet" href="<?php echo base_url('assets/bootstrap-css/bootstrap.css') ?>">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css">
    <link rel="stylesheet" href="<?php echo base_url('assets/css/mystyle_ejercicios/mystyle_letrab/mystyle_dino_dice.css') ?>">
    <link rel="shortcut icon" href="<?php echo base_url('almacenamiento/img/letra-q/dino-lapiz-amarillo.png') ?>" type="image/x-icon">
...
<body class="body-quetzal">
    <section id="header-inicial">
        <nav class="navbar navbar-color navbar-expand-lg navbar-light fixed-top">
            <div class="container-fluid">
                <div class="col-lg-3 col-md-3">
                    <a class="nav-link" href="<?php echo base_url('ejercicios/ejercicios_letra_q') ?>"><img src="<?php echo base_url('almacenamiento/img/btn-regresar.png') ?>" alt="" class="img-fluid" width="30%"></a>
                </div>
                <div class="col-lg-5 col-md-5 text-center d-none d-sm-block">
                    <img src="<?php echo base_url('almacenamiento/img/letra-q/quetzal-titulo.png') ?>" alt="" class="img-fluid" width="100%">
                </div>
    ...
    <section id="header-juego" class="d-none">
        <nav class="navbar navbar-color navbar-expand-lg navbar-light fixed-top">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-3 col-md-3">
                        <a class="nav-link" href="<?php echo base_url('ejercicios/ejercicios_letra_q/dino_dice') ?>"><img src="<?php echo base_url('almacenamiento/img/btn-regresar.png') ?>" alt="" class="img-fluid" width="30%"></a>
                    </div>
                    <div class="col-lg-6 col-md-6 d-flex justify-items-center d-none d-sm-block">
                        <img src="<?php echo base_url('almacenamiento/img/titulos/dino_dice.png') ?>" alt="" class="img-fluid" width="90%">
                    </div>
                    <div class="col-lg-3 col-md-3 d-flex justify-items-center ">
                        ...
                        <div class="col-lg-4 col-md-4 d-flex align-items-center">
                            <img src="<?php echo base_url('almacenamiento/img/movimientos.png') ?>" alt="" class="img-fluid ms-4" width="40%">
                        ...
                        <!-- <div class="col-lg-4 col-md-4 d-flex align-items-center">
                            <img src="<?php echo base_url('almacenamiento/img/movimientos.png') ?>" alt="" class="img-fluid me-2" width="50%">
                            <span class="text-azul ms-2" id="contadorCorrectos">0</span>
                        </div> -->

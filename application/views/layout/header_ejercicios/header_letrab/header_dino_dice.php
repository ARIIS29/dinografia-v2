...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo base_url('almacenamiento/img/letra-b/dino-lapiz-verde.png') ?>" type="image/x-icon">
...
<body class="body-bambu">
    <section id="header-inicial">
        <nav class="navbar navbar-color navbar-expand-lg navbar-light fixed-top">
            <div class="container-fluid">
                <div class="col-lg-3 col-md-3">
                    <a class="nav-link" href="<?php echo base_url('ejercicios/ejercicios_letra_b') ?>"><img src="<?php echo base_url('almacenamiento/img/btn-regresar.png') ?>" alt="" class="img-fluid" width="30%"></a>
                </div>
                <div class="col-lg-5 col-md-5 text-center d-none d-sm-block">
                    <img src="<?php echo base_url('almacenamiento/img/letra-b/bosque-bambu-titulo.png') ?>" alt="" class="img-fluid" width="100%">
                </div>
    ...
    <section id="header-juego" class="d-none">
        <nav class="navbar navbar-color navbar-expand-lg navbar-light fixed-top">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-3 col-md-3">
                        <a class="nav-link" href="<?php echo base_url('ejercicios/ejercicios_letra_b/dino_dice') ?>"><img src="<?php echo base_url('almacenamiento/img/btn-regresar.png') ?>" alt="" class="img-fluid" width="30%"></a>
                    </div>

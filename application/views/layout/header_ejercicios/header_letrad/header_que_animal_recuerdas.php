...
<head>
    ...
    <title>Que animal recuerdas</title>
    <!-- <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous"> -->
    <link rel="stylesheet" href="<?php echo base_url('assets/bootstrap-css/bootstrap.css') ?>">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css">
    <link rel="stylesheet" href="<?php echo base_url('assets/css/mystyle_ejercicios/mystyle_letrab/mystyle_que_animal_recuerdas.css') ?>">
            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-3 col-md-3 row">
                    <div class="col-lg-4 col-md-4 d-flex align-items-center">
                        <img src="<?php echo base_url('almacenamiento/img/reloj.png') ?>" alt="" class="img-fluid me-2" width="50%">
                        <span class="text-azul ms-2" id="temporizador">00:00</span>
                    </div>
                    <div class="col-lg-4 col-md-4 d-flex align-items-center">
                        <img src="<?php echo base_url('almacenamiento/img/movimientos.png') ?>" alt="" class="img-fluid me-2" width="50%">
                        <span class="text-azul ms-2" id="intentos">3</span>
                    </div>
                    <div class="col-lg-4 col-md-4 d-flex align-items-center">
                        <img src="<?php echo base_url('almacenamiento/img/movimientos.png') ?>" alt="" class="img-fluid me-2" width="50%">
                        <span class="text-azul ms-2" id="objetoRecolectado">0</span>
                    </div>
                </div>

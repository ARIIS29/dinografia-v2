        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-8 col-8 justify-content-center color-fondo texto_instrucciones_desierto" id="areaJuego">
                <div class="col-lg-12 col-md-12 col-12">
                    ...
                    <p>
                        Prepárate para esta emocionante misión: ¡Atrapa todas las hojas que aparezcan en la pantalla del desierto! <br>
                        <b> Cuando veas una hoja aparecer, presiona sobre ella rápidamente para atraparla.</b>
                        </button> <br>
                    </p>

                    <audio id="audioVista1" src="<?php echo base_url('almacenamiento/audios/audios_d/d_explorador_hojas.mp3') ?>" preload="auto"></audio>
                    ...
                    <p>
                        ¡Exploremos juntos esta misión en el misterioso desierto!<br>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        // });
        if (!sessionStorage.getItem('audio1Reproducido_exploradorHojasD')) {
            audio1.play().then(() => {
                sessionStorage.setItem('audio1Reproducido_exploradorHojasD', 'true');
            }).catch(error => {
                console.log("Error al reproducir audioVista1:", error);
            });
        }

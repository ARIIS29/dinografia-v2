        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-8 col-8 justify-content-center color-fondo instrucciones" id="areaJuego">
                <div class="col-lg-12 col-md-12 col-12 mt-2">
                    <p>
                    <h1>¡Bienvenidos a la aventura de playa palmeras! <br> <b>Mensajes Secretos - Letra p</b></h1> <br>
                    Prepárate para una emocionante misión: ¡Ayuda al Dino a formar los mensajes secretos que se encuentran en playa palmeras! <br>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const palabras = [{
                palabra: "Recordemos la letra p, recorriendo playa palmeras.",
                emoji: ""
            }, {
                palabra: "La letra p siempre mira a la derecha.",
                emoji: ""
            },
            {
                palabra: "Playa se escribe con la letra p.",
                emoji: ""
            },
            {
                palabra: "La letra p se encuentra en las pilas.",
                emoji: ""
            },
            {
                palabra: "Recuerda las pilas cuando escribas la letra p.",
                emoji: ""
            },
        ];
        ...
        function verificarPalabra() {
            ...
            if (!errores) {
                ...
                if (palabrasRestantes.length === 0) {
                    ...
                    enviarEvaluacionMensajesSecretosp();
                    mostrarConfeti();
                    return;
                }
        ...
        function enviarEvaluacionMensajesSecretosp() {
            var tiempo = `${formatTime(minutes)}:${formatTime(seconds)}`;
            $.ajax({
                url: '<?php echo base_url('ejercicios/ejercicios_letra_p/enviarEvaluacionMensajesSecretosp'); ?>', // URL de tu controlador
                type: 'POST',
                data: {
                    tiempoFinal: tiempo,

        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-8 col-8 justify-content-center color-fondo instrucciones" id="areaJuego">
                <div class="col-lg-12 col-md-12 col-12 mt-2">
                    <p>
                    <h1>¡Bienvenidos a la aventura de playa palmeras! <br> <b>Explorando Hojas - Letra p</b></h1> <br>
                    Prepárate para una emocionante misión: ¡Atrapa todas las hojas que aparezcan en playa palmeras! <br>
            ...
            <div class="col-lg-12 col-md-12 col-12 justify-content-center" id="contenedorJuego">
                ...
                <div class="col-lg-8 col-md-8 col-8 justify-content-center area" id="area">
                    ...
                    <img id="hoja" src="<?php echo base_url('almacenamiento/img/hojas/hojap.png') ?>" alt="HojaB" class="hoja-img" width="5%">
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function finalizarJuego() {
            ...
            enviarEvaluacionexploradorHojasP();
        }
        ...
        function enviarEvaluacionexploradorHojasP() {
            var tiempo = `${String(minutos).padStart(2, '0')}:${String(segundos).padStart(2, '0')}`;
            $.ajax({
                url: '<?php echo base_url('ejercicios/ejercicios_letra_p/enviarEvaluacionexploradorHojasP'); ?>', // URL de tu controlador
                type: 'POST',
                data: {
                    tiempoFinal: tiempo,

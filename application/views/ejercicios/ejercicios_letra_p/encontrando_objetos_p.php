        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-8 col-8 justify-content-center color-fondo instrucciones" id="areaJuego">
                <div class="col-lg-12 col-md-12 col-12 mt-2">
                    <p>
                    <h1>¡Bienvenidos a la aventura de playa palmeras! <br> <b>Elementos perdidos - Letra p</b></h1> <br>
                    ¡Prepárate para una emocionante misión! Ayuda al dino a encontrar todos los elementos perdidos en playa palmeras. ¡Todos tienen algo en común: contienen la letra p!<br>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function comprobarRespuesta(emojiElemento) {
            ...
            if (emojiSeleccionado === emojiCorrecto.emoji) {
                ...
                if (intentos <= 0) {
                    ...
                    enviarEvaluacionEncontrandoObjetosD();
        ...
        function enviarEvaluacionEncontrandoObjetosD() {
            var tiempo = `${String(minutos).padStart(2, '0')}:${String(segundos).padStart(2, '0')}`;

            $.ajax({
                url: '<?php echo base_url('ejercicios/ejercicios_letra_d/enviarEvaluacionEncontrandoObjetosD'); ?>', // URfL de tu controlador
                type: 'POST',
                data: {
                    tiempoFinal: tiempo,

        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-8 col-8 justify-content-center color-fondo instrucciones" id="areaJuego">
                <div class="col-lg-12 col-md-12 col-12 mt-2">
                    <p>
                    <h1>¡Bienvenidos a la aventura de playa palmeras! <br> <b>Descubriendo Palabras - Letra p</b></h1> <br>
                    Prepárate para una emocionante misión: ¡Ayuda al Dino! a descubrir las palabras que se esconden en playa palmeras! <br>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const palabras = [{
                palabra: "pilas",
                emoji: "<?php echo base_url('almacenamiento/img/letra-p/pilas.png'); ?>"
            },
            {
                palabra: "playa",
                emoji: "<?php echo base_url('almacenamiento/img/letra-p/playa-img.png'); ?>"

            },
            {
                palabra: "palmeras",
                emoji: "<?php echo base_url('almacenamiento/img/letra-p/palmeras.png'); ?>"
            },
            {
                palabra: "paraguas",
                emoji: "<?php echo base_url('almacenamiento/img/letra-p/paraguas.png'); ?>"
            },
            {
                palabra: "pala",
                emoji: "<?php echo base_url('almacenamiento/img/letra-p/pala.png'); ?>"
            },
        ];
        ...
        function verificarPalabra() {
            ...
            if (!errores) {
                ...
                if (palabrasRestantes.length === 0) {
                    ...
                    enviarEvaluacionDescubriendoPalabrasP();
                    mostrarConfeti();
                    return;
                }
        ...
        function enviarEvaluacionDescubriendoPalabrasP() {
            var tiempo = `${formatTime(minutes)}:${formatTime(seconds)}`;
            $.ajax({
                url: '<?php echo base_url('ejercicios/ejercicios_letra_p/enviarEvaluacionDescubriendoPalabrasP'); ?>', // URL de tu controlador
                type: 'POST',
                data: {
                    tiempoFinal: tiempo,

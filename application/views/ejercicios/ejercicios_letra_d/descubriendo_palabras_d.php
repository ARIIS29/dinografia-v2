        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-8 col-8 justify-content-center color-fondo instrucciones" id="areaJuego">
                <div class="col-lg-12 col-md-12 col-12 mt-2">
                    <p>
                    <h1>¡Bienvenidos a la aventura del desierto! <br> <b>Descubriendo Palabras - letra d</b></h1> <br>
                    Prepárate para una emocionante misión: ¡Ayuda al Dino! a descubrir las palabras que se esconden en el desierto! <br>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const palabras = [{
                palabra: "diario",
                emoji: "<?php echo base_url('almacenamiento/img/letra-d/diario.png'); ?>"
            },
            {
                palabra: "desierto",
                emoji: "<?php echo base_url('almacenamiento/img/letra-d/desierto-img.png'); ?>"

            },
            {
                palabra: "duraznos",
                emoji: "<?php echo base_url('almacenamiento/img/letra-d/duraznos.png'); ?>"
            },
            {
                palabra: "dados",
                emoji: "<?php echo base_url('almacenamiento/img/letra-d/dados.png'); ?>"
            },
            {
                palabra: "dinosaurio",
                emoji: "<?php echo base_url('almacenamiento/img/letra-d/dinosaurio.png'); ?>"
            },
        ];
        ...
        function enviarEvaluacionDescubriendoPalabrasD() {
            ...
            $.ajax({
                url: '<?php echo base_url('ejercicios/ejercicios_letra_d/enviarEvaluacionDescubriendoPalabrasD'); ?>', // URL de tu controlador
                type: 'POST',
                data: {
                    tiempoFinal: tiempo,

        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-8 col-8 justify-content-center color-fondo instrucciones" id="areaJuego">
                <div class="col-lg-12 col-md-12 col-12 mt-2">
                    <p>
                    <h1>¡Bienvenidos a la aventura del desierto! <br> <b>Mensajes Secretos - Letra d</b></h1> <br>
                    Prepárate para una emocionante misión: ¡Ayuda al Dino a formar los mensajes secretos que se encuentran en el desierto! <br>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const palabras = [{
                palabra: "Haciendo una exploración en el desierto.",
                emoji: ""
            }, {
                palabra: "Desierto se escribe con la letra d.",
                emoji: ""
            },
            {
                palabra: "La letra d siempre camina a la izquierda.",
                emoji: ""
            },
            {
                palabra: "La letra d se encuentra en el diario.",
                emoji: ""
            },
            {
                palabra: "Recuerda el diario cuando escribas la letra d.",
                emoji: ""
            },
        ];
        ...
        function verificarPalabra() {
            ...
            if (!errores) {
                ...
                if (palabrasRestantes.length === 0) {
                    ...
                    enviarEvaluacionMensajesSecretosd();
                    mostrarConfeti();
                    return;
                }
        ...
        function enviarEvaluacionMensajesSecretosd() {
            var tiempo = `${formatTime(minutes)}:${formatTime(seconds)}`;
            $.ajax({
                url: '<?php echo base_url('ejercicios/ejercicios_letra_d/enviarEvaluacionMensajesSecretosd'); ?>', // URL de tu controlador
                type: 'POST',
                data: {
                    tiempoFinal: tiempo,

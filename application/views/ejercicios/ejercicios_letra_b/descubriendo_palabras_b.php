        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-8 col-8 justify-content-center color-fondo instrucciones" id="areaJuego">
                <div class="col-lg-12 col-md-12 col-12 mt-2">
                    <p>
                    <h1>¡Bienvenidos a la aventura del bosque de bambú! <br> <b>Descubriendo Palabras - letra b</b></h1> <br>
                    Prepárate para una emocionante misión: descubrir las palabras que se esconden en el bosque de bambú! <br>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const palabras = [{
                palabra: "bambú",
                emoji: "<?php echo base_url('almacenamiento/img/letra-b/bambu_img.png'); ?>"
            },
            {
                palabra: "bosque",
            ...
            {
                palabra: "botella",
                emoji: "<?php echo base_url('almacenamiento/img/letra-b/botella.png'); ?>"
            },
            {
                palabra: "brújula",
                emoji: "<?php echo base_url('almacenamiento/img/letra-b/brujula.png'); ?>"
            },
            {
                palabra: "binoculares",
                emoji: "<?php echo base_url('almacenamiento/img/letra-b/binoculares.png'); ?>"
            },
        ];
        ...
        function enviarEvaluacionDescubriendoPalabrasB() {
            ...
            $.ajax({
                url: '<?php echo base_url('ejercicios/ejercicios_letra_b/enviarEvaluacionDescubriendoPalabrasB'); ?>', // URL de tu controlador
                type: 'POST',
                data: {
                    tiempoFinal: tiempo,

        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-8 col-8 justify-content-center color-fondo instrucciones" id="areaJuego">
                <div class="col-lg-12 col-md-12 col-12 mt-2">
                    <p>
                    <h1>¡Bienvenidos a la aventura del bosque de quetzal! <br> <b>Elementos Pedidos - Letra q</b></h1> <br>
                    ¡Prepárate para una emocionante misión! Ayuda al dino a encontrar todos los elementos perdidos en el bosque del quetzal. ¡Todos tienen algo en común: contienen la letra q!<br>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const frutasDisponibles = [{
            ...
            {
                emoji: "🎿",
                nombre: "calzado para esquiar"
            },
            {
                emoji: "🌳",
                nombre: "quercus - nombre científico que incluye árboles como el encino y el roble"
            }
        ];
        ...
        function comprobarRespuesta(emojiElemento) {
            ...
            if (emojiSeleccionado === emojiCorrecto.emoji) {
                ...
                if (intentos <= 0) {
                    ...
                    enviarEvaluacionEncontrandoObjetosQ();
        ...
        function enviarEvaluacionEncontrandoObjetosQ() {
            var tiempo = `${String(minutos).padStart(2, '0')}:${String(segundos).padStart(2, '0')}`;

            $.ajax({
                url: '<?php echo base_url('ejercicios/ejercicios_letra_q/enviarEvaluacionEncontrandoObjetosQ'); ?>', // URfL de tu controlador
                type: 'POST',
                data: {
                    tiempoFinal: tiempo,

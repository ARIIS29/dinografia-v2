        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-8 col-8 justify-content-center color-fondo instrucciones" id="areaJuego">
                <div class="col-lg-12 col-md-12 col-12 mt-2">
                    <p>
                    <h1>¡Bienvenidos a la aventura del bosque del quetzal! <br> <b>Mensajes Secretos - Letra q</b></h1> <br>
                    Prepárate para una emocionante misión: ¡Ayuda al Dino a formar los mensajes secretos que se encuentran en el bosque del quetzal! <br>
            ...
            <div class="col-lg-12 col-md-12 col-12" id="contenedorJuego">
                ...
                <div class="d-flex justify-content-center mt-4">
                    ...
                    <button id="saltarPalabraBtn" class="btn saltar me-2" title="Saltar Oración">
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const palabras = [{
                palabra: "Recorriendo el bosque del quetzal.",
                emoji: ""
            }, {
                palabra: "La letra q siempre mira a la izquierda.",
                emoji: ""
            },
            {
                palabra: "Quetzal se escribe con la letra q.",
                emoji: ""
            },
            {
                palabra: "La letra q la encontramos en el queso.",
                emoji: ""
            },
            {
                palabra: "Recuerda el queso cuando escribas la letra q.",
                emoji: ""
            },
        ];
        ...
        function verificarPalabra() {
            ...
            if (!errores) {
                ...
                if (palabrasRestantes.length === 0) {
                    ...
                    enviarEvaluacionMensajesSecretosq();
                    mostrarConfeti();
                    return;
                }
        ...
        function enviarEvaluacionMensajesSecretosq() {
            var tiempo = `${formatTime(minutes)}:${formatTime(seconds)}`;
            $.ajax({
                url: '<?php echo base_url('ejercicios/ejercicios_letra_q/enviarEvaluacionMensajesSecretosq'); ?>', // URL de tu controlador
                type: 'POST',
                data: {
                    tiempoFinal: tiempo,

...
<section class="mt-8">
    <div class="container">
        ...
        <div class="col-lg-6 col-md-6 d-none d-sm-block">
            ...
            <img src="<?php echo base_url('almacenamiento/img/letra-q/msjq1.png') ?>" alt="" class="img-fluid" width="70%">
        </div>
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-12">
                ...
                <video controls>
                    <source src="<?php echo base_url('almacenamiento/img/letra-q/letraq-escritura.mp4'); ?>" type="video/mp4">
                </video>
            </div>
            <!-- Columna para la imagen de fondo y el canvas -->
            <div class="col-lg-6 col-md-6 col-12" style="position: relative;">
                <!-- Imagen de fondo -->
                <img id="fondo-letrab" src="<?php echo base_url('almacenamiento/img/letra-q/letra-q.gif'); ?>" alt="Background Image" style="display: block;" class="img-fluid">
                <!-- Canvas para dibujar -->
                <canvas id="canvas" style="border:1px solid #000000;"></canvas>
                <br>
                <!-- Selector de color -->
                <input type="color" id="color" value="#FECB00" title="Gama de colores">
                <!-- Selector de grosor -->
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        botonGuardar.addEventListener('click', () => {
            ...
            imagenFondo.onload = () => {
                ...
                fetch(baseUrl + 'leccionq/guardarImagen', {
                        method: 'POST',
        ...
        function mostrarMensajeExito() {
            ...
            mensaje.textContent = '¡Captura guardada con éxito en la galería Q!';

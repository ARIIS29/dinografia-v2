    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-12">
                ...
                <video controls>
                    <source src="<?php echo base_url('almacenamiento/img/letra-b/letrab-escritura.mp4'); ?>" type="video/mp4">
                </video>
            </div>
            <!-- Columna para la imagen de fondo y el canvas -->
            <div class="col-lg-6 col-md-6 col-12" style="position: relative;">
                <!-- Imagen de fondo -->
                <img id="fondo-letrab" src="<?php echo base_url('almacenamiento/img/letra-b/letra-b.gif'); ?>" alt="Background Image" style="display: block;" class="img-fluid">
                <!-- Canvas para dibujar -->
